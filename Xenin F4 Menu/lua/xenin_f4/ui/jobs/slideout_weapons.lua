...
-- Since weapons.Get can't get HL2 weps
PANEL.HL2 = {
	["weapon_bugbait"] = { name = "Bugbait", model = "models/weapons/w_bugbait.mdl" },
	["weapon_357"] = { name = ".357 Magnum", model = "models/weapons/w_357.mdl" },
	...
	["weapon_crowbar"] = { name = "Crowbar", model = "models/weapons/w_crowbar.mdl" },
	["weapon_frag"] = { name = "Grenade", model = "models/weapons/w_grenade.mdl" },
	["weapon_physcannon"] = { name = "Gravity Gun", model = "models/weapons/w_Physics.mdl" },
	["weapon_ar2"] = { name = "Pulse-Rifle", model = "models/weapons/w_irifle.mdl" },
	["weapon_rpg"] = { name = "RPG", model = "models/weapons/w_rocket_launcher.mdl" },
	["weapon_slam"] = { name = "S.L.A.M", model = "	models/weapons/w_slam.mdl" },
	["weapon_shotgun"] = { name = "Shotgun", model = "models/weapons/w_shotgun.mdl" },
	["weapon_smg1"] = { name = "SMG", model = "models/weapons/w_smg1.mdl"},
	["weapon_stunstick"] = { name = "Stunstick", model = "models/weapons/w_stunbaton.mdl" }
}

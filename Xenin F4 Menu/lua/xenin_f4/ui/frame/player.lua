...
function PANEL:Init()
  ...
  self.Text.Rows = {
    { font = "F4Menu.Player.Name", text = ply:Nick(), color = color_white },
    { font = "F4Menu.Player.Job", text = team.GetName(ply:Team()), color = team.GetColor(ply:Team()) },
  }
  ...
  -- No clientside hook for this shit, smfh
